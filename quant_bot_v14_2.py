"""
╔══════════════════════════════════════════════════════════════╗
║         Quantitative Trading Bot  —  Version V14.2          ║
...
TRADE_LOG_FILE  = "trade_log_v14_2.csv"
...
async def main():
    log("=" * 65)
    log("Quantitative Trading Bot V14.2 — Starting up")
    log("─" * 65)
    log("Tuning in V14.2:")
    log("   • Dynamic scanner: dollar-volume leaders first (top 400 + 600 random fill)")
    log("   • VWAP_DEVIATION_MIN_PCT: 0.6->0.9 (less IEX noise)")
    log("   • All V14.1 Sweep + VPIN + OBAD features carried over")
    log("─" * 65)
